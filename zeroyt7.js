...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		mess = {
			...
			success: 'Done Jangan Lupa Dukung MAYY BOTZ',
			error: {
...
var ase = new Date();
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = zeroyt7.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "LIST MENU","footerText": "Dukung MAYY BOTZ\nMade With Mayy","listType": "SINGLE_SELECT","sections": list}}, {})
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: `Dukung MAYY BOTZ`, 
                            orderTitle: `Dukung MAYY BOTZ`,
...
*┗━━━━━━━ •*`
        ...
        sendButton(from, teks, '©Created : MAYY BOTZ', but, mek)
break
case 'sewat':
...
costum(buffer, sticker, Verived, `Jangan Lupa Dukung MAYY BOTZ`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `Jangan Lupa Dukung MAYY BOTZ`)
fs.unlinkSync(ran)
})
break
case 'tomp3':
...
fs.unlinkSync(anum)
buffer = fs.readFileSync(ran)
zeroyt7.sendMessage(from, buffer, video, { quoted: ftrol, caption: 'Done... Jangan Lupa Dukung MAYY BOTZ' })
fs.unlinkSync(ran)
})
break
...
case 'youtube':
teks =
`Nih Instagram Owner Ku Jangan Lupa Di Follow Ya https://instagram.com/mayy60573`
...
case 'tiktok':
teks =
`Nih Tiktok Owner Ku Jangan Lupa Di Follow Ya https://tiktok.com/@yasz.ganz`
zeroyt7.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'sourcecode':
case 'script':
...
├ Sc Full Fitur = 
├─────────────────────
├ Creator Base = MAYY BOTZ
├ Creator Sc = MAYY BOTZ
└─────────────────────`
zeroyt7.sendMessage(from, teks, text, {quoted: ftrol})
break
case "on":
...
//━━━━━━━━━━━━━━━[ FITUR MAKER ]━━━━━━━━━━━━━━━━━//
        ...
        break
        case "sertiff1":
        if (args.length < 1) return reply(`Teksnya Mana Tod ?\nContoh: ${prefix + command}MAYY BOTZ`)
        pll = body.slice(10);
        reply("Loading.....");
        ...
        case "googlem":
				...
				if (args.length < 1) return reply(`Teksnya Mana Tod ?\nContoh: ${prefix + command}MAYY BOTZ | ganteng | banget`)
				reply(mess.wait)
kontol = body.slice(8)
...
//━━━━━━━━━━━━━━━[ FITUR RANDOM IMAGE ]━━━━━━━━━━━━━━━━━//
      ...
      case "aeshtetic":
      case "wallpaperanime":
      sendButton(from, `Random Image By MAYY BOTZ`, `press the button below`, [
          {
...
reply(mess.wait)
zeroyt7.sendMessage(from, gambar, image, { quoted: ftrol, caption: 'Nih Jangan Lupa Dukung MAYY BOTZ'})
})
break
default:
if (isOwner) {
